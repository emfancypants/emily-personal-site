...
import { Projectcardmobile } from '../../components';
...
const Projectsmobile = () => {
  return (
    <div className='websitemobile__proj' id='projectsmobile'>
      <div className='websitemobile__proj-title'>
        <h1>My Projects</h1>
      </div>


      <div className='ProjectsCardsmobile'>
        <Projectcardmobile link = 'https://github.com/emfancypants/emily-personal-site' image = {website} title = "My Personal Portfolio" duration = "June 2023 - Present"
        ...
        <Projectcardmobile link = 'https://github.com/ShyamalSankar/Twitter-bot-detection' image = {twitter} title = "Twitter Bot or Not?" duration = "March 2023 - April 2023"
        ...
        <Projectcardmobile link = 'https://github.com/emfancypants/Canny' image = {canny} title = "Orbital 2021 - Apollo Level" duration = "May 2021 - Aug 2021"
