  ...
  return (
    <div className='website__about' id='about'>
      ...
      <div className='Aboutcards'>
        ...
        <Aboutcard picture = {student} title = "Student" content = "I am a Year 4 Undergraduate Majoring in Business Analytics with a Specialization in Marketing at the National University of Singapore (NUS)" />
